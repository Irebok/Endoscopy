...
void FusionAhrsInitialise(FusionAhrs *const ahrs) {
    ...
    FILE* log = fopen("fusion_log.txt", "a");
    if (log) {
        fprintf(log, "FusionAhrs struct offsets:\n");
        fprintf(log, "  settings:                    %zu\n", offsetof(FusionAhrs, settings));
        fprintf(log, "  quaternion:                  %zu\n", offsetof(FusionAhrs, quaternion));
        fprintf(log, "  accelerometer:               %zu\n", offsetof(FusionAhrs, accelerometer));
        fprintf(log, "  initialising:                %zu\n", offsetof(FusionAhrs, initialising));
        fprintf(log, "  rampedGain:                  %zu\n", offsetof(FusionAhrs, rampedGain));
        fprintf(log, "  rampedGainStep:              %zu\n", offsetof(FusionAhrs, rampedGainStep));
        fprintf(log, "  angularRateRecovery:         %zu\n", offsetof(FusionAhrs, angularRateRecovery));
        fprintf(log, "  halfAccelerometerFeedback:   %zu\n", offsetof(FusionAhrs, halfAccelerometerFeedback));
        fprintf(log, "  halfMagnetometerFeedback:    %zu\n", offsetof(FusionAhrs, halfMagnetometerFeedback));
        fprintf(log, "  accelerometerIgnored:        %zu\n", offsetof(FusionAhrs, accelerometerIgnored));
        fprintf(log, "  accelerationRecoveryTrigger: %zu\n", offsetof(FusionAhrs, accelerationRecoveryTrigger));
        fprintf(log, "  accelerationRecoveryTimeout: %zu\n", offsetof(FusionAhrs, accelerationRecoveryTimeout));
        fprintf(log, "  magnetometerIgnored:         %zu\n", offsetof(FusionAhrs, magnetometerIgnored));
        fprintf(log, "  magneticRecoveryTrigger:     %zu\n", offsetof(FusionAhrs, magneticRecoveryTrigger));
        fprintf(log, "  magneticRecoveryTimeout:     %zu\n", offsetof(FusionAhrs, magneticRecoveryTimeout));
        fprintf(log, "  sizeof(FusionAhrs):          %zu\n", sizeof(FusionAhrs));
        fclose(log);
    }
