    ...
    void Update()
    {
        ...
        {   
            ...
            if (i == 10)
            {
                ...
                provider.setMagBias(Verifier.SensorType.MidTube, new Vector3((float)103.19, (float)199.28, (float)-240.74), m4x4End);  // Nueva calibracion  
                ...
                provider.setMagBias(Verifier.SensorType.EndTube, new Vector3((float)39.63, (float)49.72, (float)-31.31), m4x4Mid);  // Nueva calibracion 
